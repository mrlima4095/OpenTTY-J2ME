...
function quest() os.execute("execute install nano; add quest.title=Perguntando; add quest.label=Digite algo; add quest.key=TEXT_LUA; add quest.cmd=exec unset ESTADO & lua teste.lua; x11 quest nano; get nano;") end
