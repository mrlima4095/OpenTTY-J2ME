...
class Lua {
    ...
    public class LuaFunction implements CommandListener, ItemCommandListener {
        ...
        public Object internals(Vector args) throws Exception {
            ...
            else if (MOD == IMG) { return args.isEmpty() || args.elementAt(0) == null ? gotbad(1, "render", "string expected, got" + type(args.elementAt(0))) : midlet.readRaw(toLuaString(args.elementAt(0))); }
            // Package: string
