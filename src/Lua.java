        ...
        public Object internals(Vector args) throws Exception {
            ...
            // Package: io
                ...
                if (args.isEmpty()) { } 
                    ...
                    Hashtable scope = (args.size() < 4) ? father : (args.elementAt(4) instanceof Hashtable ? (Hashtable) args.elementAt(4) : (Hashtable) gotbad(5, "popen", "table expected, got " + type(args.elementAt(4))));
