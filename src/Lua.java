...
public class Lua {
    ...
    public Lua(OpenTTY midlet, int id, Object stdout, Hashtable scope) {
        ...
        String[] funcs = new String[] { "execute", "getenv", "clock", "setlocale", "exit", "date", "getpid", "setproc", "getproc", "getcwd", "request" }; int[] loaders = new int[] { EXEC, GETENV, CLOCK, SETLOC, EXIT, DATE, GETPID, SETPROC, GETPROC, GETCWD, REQUEST };
            ...
            // Package: io
                ...
                if (args.isEmpty()) { }
                    ...
                    if (args.size() > 1 && args.elementAt(1) instanceof InputStream) { return gotbad(2, "write", "output stream expected, got input"); }  
                        ...
                        return midlet.writeRMS(out, mode ? midlet.getcontent(out) + content : content, id);
                    }
                }
            }
            else if (MOD == CLOSE) {
