                ...
                if (payload instanceof String) {
                    if (payload.equals("kill")) {
                        if (arg == null || arg.equals("")) { return new Double(2); }
                            ...
                            if (midlet.getobject((String) arg).equals(scope.get("USER")) || id == 0) { midlet.sys.remove(arg); return new Double(0); } 
                            else { return new Double(13); }
                        }
                        ...
                        if (arg == null || arg.equals("")) { return new Double(2); }
                            ...
                            if (midlet.getobject((String) arg).equals(scope.get("USER")) || id == 0) { return midlet.sys.get(arg); } 
                            else { return new Double(13); }
                        }
                        else { return new Double(127); }
                    }
