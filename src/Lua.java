...
public class Lua {
    ...
    public static final int CLASS = 700, NAME = 701, DELETE = 702, UPTIME = 703, THREAD = 704;
    ...
    public Lua(OpenTTY midlet, int id, String pid, Hashtable proc, Object stdout, Hashtable scope) {
        ...
        funcs = new String[] { "class", "getName", "delete", "run" }; 
        loaders = new int[] { CLASS, NAME, DELETE, THREAD }
