...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public class NanoEditor implements CommandListener { 
        ...
        public void commandAction(Command c, Displayable d) { 
            if (c == backCommand) { nanoContent = screen.getString(); processCommand("xterm"); } 
            else if (c == clearCommand) { screen.setString(""); } else if (c == runCommand) { nanoContent = screen.getString(); processCommand("xterm"); runScript(nanoContent); } else if (c == importCommand) { nanoContent = screen.getString(); processCommand("xterm"); importScript("nano"); } else if (c == viewCommand) { nanoContent = screen.getString(); viewer(extractTitle(nanoContent), html2text(nanoContent)); } } }
