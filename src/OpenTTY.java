...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private String run(Vector source, Hashtable context, boolean root, Hashtable program, int mode) throws RuntimeException {
        ...
        for (int i = 0; i < source.size(); i++) {
            ...
            if (type == null) { }
            else if (type.equals("printf")) { String text = format(substValues((String) cmd.get("value"), vars, program, root)); stdout.setText(stdout.getText().equals("") ? text : stdout.getText() + "\n" + text); }
