...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private String logs = "", path = "/home/", build = "2025-1.16-02x28"; 
    ...
    private int processCommand(String command, boolean ignore, boolean root) { 
        ...
        else if (mainCommand.equals("build")) { return executeC(C(getcontent(argument))); }
    ...
    for (int i = 0; i < instrs.size(); i++) {
        ...
        if (tipo.equals("printf")) {
            echoCommand("" + exprCommand((String) cmd.get("args")));
        }
        ...
        if (tipo.equals("call")) {
            ...
            if (!functions.containsKey(fname)) {
                echoCommand("Função '" + fname + "' não existe");
                return 1;
            }
