...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private void processCommand(String command) {
        ...
        else if (mainCommand.equals("dsf")) { new externalAPI(); }
    ...
    public ExternalAPI() {
        ...
        files.setCommandListener(new CommandListener() {
            public void commandAction(Command c, Displayable d) {
                if (c == back) {
                    // Voltar para o diretório anterior ou para o form principal
                    ...
                    if (index >= 0) {
                        ...
                        if (selected.endsWith("/")) {
                            // Se é um diretório, navega para ele
                            listDirectory(newPath);
                        } else {
                            // Caso seja um arquivo, podemos chamar um método para manipulá-lo
                            importScript(newPath); // Exemplo de operação no arquivo
                        }
                    }
                }
            }
        ...
        listRoots(); // Lista os diretórios raiz ao iniciar
    }
    ...
    private void listRoots() {
        ...
        try {
            ...
            showError("Erro ao listar roots: " + e.getMessage());
        }
    }
    ...
    private void listDirectory(String path) {
        ...
        try {
            ...
            showError("Erro ao listar diretório: " + e.getMessage());
        }
    }
    ...
    private void showError(String message) {
        ...
        display.setCurrent(alert, files);
    }
}
