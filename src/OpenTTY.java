...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public Hashtable attributes = new Hashtable(), paths = new Hashtable(), trace = new Hashtable(), filetypes = null, aliases = new Hashtable(), shell = new Hashtable(), functions = new Hashtable();
    public Hashtable<String, String> tmp = new Hashtable<String, String>(), cache = new Hashtable<String, String>();
    ...
    public int processCommand(String command, boolean ignore, int id) { 
        ...
        // Directories Manager
            ...
            try { 
                if (PWD.equals("/tmp/")) {
                    ...
                    String content = loadRMS("OpenRMS", PWD.equals("/bin/") ? 3 : 4);
                    int index = 0;
        ...
        // RMS Files
            ...
            if (argument.equals("")) { }
                ...
                if (args[0].equals("/bin/") || args[0].equals("/lib/")) { return writeRMS("OpenRMS", new byte[0], args[0].equals("/bin/") ? 3 : args[1].equals("/etc/") ? 5 : 4, 0); }
