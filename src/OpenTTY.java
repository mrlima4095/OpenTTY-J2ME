...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public class Screen implements CommandListener {
        ...
        public void commandAction(Command c, Displayable d) { if (c == backCommand) { processCommand("xterm"); processCommand(lib.containsKey("screen.back") ? (String) lib.get("screen.back") : "true"); } else if (c == userCommand) { processCommand("xterm"); processCommand(lib.containsKey("screen.button.cmd") ? (String) lib.get("screen.button.cmd") : "log add warn An error occurred, 'screen.button.cmd' not found"); } }
    }
