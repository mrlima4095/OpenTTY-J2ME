    ...
    private Vector parseBlock(String block, Hashtable context) {
        ...
        for (int i = 0; i < lines.length; i++) {
            ...
            if (line.equals("") || line.equals("' '")) { } 
                ...
                echoCommand("build: invalid token 'else'");
                return null;
            } 
