...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    //| (Windows)
    private int loadScreen(int ITEM) {
        MOD = ITEM;
        ...
        if (MOD == MONITOR) {
            ...
            if (MOD == EXPLORER) { preview.addCommand(BACK); preview.addCommand(OPEN); } 
            else if (MOD == PROCESS) { preview.addCommand(BACK); preview.addCommand(KILL); }
            else if (MOD == PREVIEW) { preview.addCommand(BACK); preview.addCommand(RUN); preview.addCommand(EDIT); } 
    ...
    private int load(int ITEM) {
        ...
        if (MOD == PREVIEW) { preview.deleteAll(); for (int i = 0; i < history.size(); i++) { preview.append((String) history.elementAt(i), null); } } 
        else if (MOD == EXPLORER) {
    ...
    private int processCommand(String command, boolean ignore, boolean root) { 
        ...
        else if (mainCommand.equals("top")) { if (argument.equals("") || argument.equals("memory")) { loadScreen(MONITOR); } else if (argument.equals("process")) { loadScreen(PROCESS); } else if (argument.equals("used")) { echoCommand("" + (runtime.totalMemory() - runtime.freeMemory()) / 1024); } else if (argument.equals("free")) { echoCommand("" + runtime.freeMemory() / 1024); } else if (argument.equals("total")) { echoCommand("" + runtime.totalMemory() / 1024); } else { echoCommand("top: " + getCommand(argument) + ": not found"); return 127; } }
        // |
        // Process
        ...
        else if (mainCommand.equals("dir")) { loadScreen(EXPLORER); }
        ...
        // |
        // General Utilities
        else if (mainCommand.equals("history")) { loadScreen(PREVIEW); }
