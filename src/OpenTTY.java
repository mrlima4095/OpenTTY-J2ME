...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public int processCommand(String command, boolean ignore, int id) { 
        ...
        else if (mainCommand.equals("id")) { echoCommand(argument.equals("") ? String.valueOf(id) : argument.equals("root") ? "0" : argument.equals(loadRMS("OpenRMS")) ? "1" : "id: " + argument + ": no such user"); }
