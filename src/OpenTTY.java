            ...
            // Package: string
                ...
                if (args.isEmpty()) { }
                    ...
                    if (args.elementAt(0) == null || pattern == null) { }
                        ...
                        int pos = text.indexOf(pattern, args.size() > 2 ? (args.elementAt(2) instanceof Double ? ((Double) args.elementAt(2)).intValue() : (int) gotbad(3, "match", "number expected, got " + type(args.elementAt(2)))) : 0);
