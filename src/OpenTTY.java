...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private String readStack() { StringBuffer sb = new StringBuffer(); sb.append(path); for (int i = 0; i < stack.size(); i++) { sb.append(" ").append((String) dirStack.elementAt(i)); } return sb.toString(); }
    // |
    // RMS Files
