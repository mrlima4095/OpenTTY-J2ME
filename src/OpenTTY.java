...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private int processCommand(String command, boolean ignore, boolean root) { 
        ...
        // System UI
            ...
            else { return xserver("tick " + argument); } 
        }
        ...
        // Process
            ...
            while (KEYS.hasMoreElements()) { 
                String KEY = (String) KEYS.nextElement(), PID = (String) trace.get(KEY); 
                echoCommand(PID + "\t" + KEY); 
            } 
        }
        ...
        // Properties
            ...
            String INFO = argument.equals("") || argument.equals("-i") ? "$TYPE" : argument.equals("-a") || argument.equals("--all") ? "$TYPE (OpenTTY $VERSION) main/$RELEASE " + build + " - $CONFIG $PROFILE" : argument.equals("-r") || argument.equals("--release") ? "$VERSION" : argument.equals("-v") || argument.equals("--build") ? build : argument.equals("-s") ? "J2ME" : argument.equals("-m") ? "$PROFILE" : argument.equals("-p") ? "$CONFIG" : argument.equals("-n") ? "$HOSTNAME" : null;
...
*/
        ...
        // MIDlet Tracker
            ...
            final String CMD = argument; 
            final boolean IGNORE = ignore, ROOT = root; 

            new Thread("Background") { public void run() { processCommand(CMD, IGNORE, ROOT); } }.start(); 
        }
        ...
        // PushRegistry
            ...
            catch (Exception e) { echoCommand(getCatch(e)); return 3; } 
        }
        ...
        // IP Tools
            ...
            try { 
                SocketConnection CONN = (SocketConnection) Connector.open("socket://" + argument); 
                echoCommand(CONN.getLocalAddress()); CONN.close(); 
            } 
            catch (Exception e) { echoCommand("null"); return 101; } 
        }
        // |
