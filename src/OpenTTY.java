...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private void xserver(String command) {
        ...
        else if (mainCommand.equals("font")) { if (argument.equals("")) { xserver("font default"); } else { Item item = display.getCurrentItem(); if (argument.equals("default")) { item.setFont(Font.getDefaultFont()); } else if (argument.equals("bold")) { item.setFont(Font.getFont(Font.FACE_SYSTEM, Font.STYLE_BOLD, Font.SIZE_MEDIUM)); } else if (argument.equals("italic")) { item.setFont(Font.getFont(Font.FACE_SYSTEM, Font.STYLE_ITALIC, Font.SIZE_MEDIUM)); } else if (argument.equals("small")) { item.setFont(Font.getFont(Font.FACE_SYSTEM, Font.STYLE_PLAIN, Font.SIZE_SMALL)); } else if (argument.equals("large")) { item.setFont(Font.getFont(Font.FACE_SYSTEM, Font.STYLE_PLAIN, Font.SIZE_LARGE)); } else if (argument.equals("monospace")) { item.setFont(Font.getFont(Font.FACE_MONOSPACE, Font.STYLE_PLAIN, Font.SIZE_MEDIUM)); } } }
    ...
    public class ScreenList implements CommandListener {
        ...
        public void commandAction(Command c, Displayable d) {
            if (c == backCommand) {
                ...
                if (index >= 0) {
                    processCommand("xterm");
                    processCommand(lib.containsKey(screen.getString(index)) ? (String) lib.get(env(screen.getString(index))) : "log add warn An error occurred, '" + env(screen.getString(index)) + "' not found");
                }
            }
        }
    }
    ...
    public class MyCanvas extends Canvas implements CommandListener {
        ...
        public void commandAction(Command c, Displayable d) { 
            if (c == backCommand) { 
                processCommand("xterm"); 
                processCommand(lib.containsKey("canvas.back") ? (String) lib.get("canvas.back") : "true"); 
            } else if (c == userCommand) { 
                processCommand("xterm"); 
