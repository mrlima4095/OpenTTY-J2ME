...
class Lua {
    ...
    public Lua(OpenTTY midlet, boolean root) {
        ...
        Hashtable os = new Hashtable(), io = new Hashtable(), string = new Hashtable();
    ...
    public class LuaFunction {
        ...
        public Object internals(Vector args) throws Exception {
            ...
            else if (MOD == RANDOM) { return midlet.random.nextDouble(args.isEmpty() ? new Double(1.0) : Double.valueOf(toLuaString(args.elementAt(0)))); }
