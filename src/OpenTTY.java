        ...
        // General 
            ...
            if (argument.equals("")) {
                ...
                if (argument.startsWith("/")) { 
                    ...
                    echoCommand("" + loadRMS(replace(argument, "rms://", ""), 1).hashCode());
                } 
                else if (argument.equals("nano")) { 
                    echoCommand("" + nanoContent.hashCode());
                } 
                else { 
                    echoCommand("" + read(path + "/" + argument).hashCode()); 
                }
            }
