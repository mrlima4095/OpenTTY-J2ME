...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private void processCommand(String command, boolean ignore) {
        ...
        // Device Files
            ...
            if (argument.equals("")) { } 
                ...
                try { 
                    ...
                    String in = (String) args.get("if"), out = (String) args.get("of");
        ...
        else if (mainCommand.equals(".")) { if (argument.equals("")) { } else { runScript(getcontent(argument)); } }
    ...
    private String env(String text) { 
