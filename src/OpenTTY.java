...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public static class Monitor implements CommandListener {
    ...
    // |
    // Connector
    public static class Connect implements CommandListener, Runnable {
