...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private int processCommand(String command, boolean ignore, boolean root) { 
        ...
        else if (mainCommand.equals("passwd")) { if (argument.equals("")) { } else { if (root) { writeRMS("/home/.passwd", ("" + argument.hashCode()).getBytes(), true); } else { echoCommand("passwd: permission denied"); return 13; } } }
        ...
        else if (mainCommand.equals("bg")) { final String CMD = argument, IGNORE = ignore, ROOT = root; new Thread("Background") { public void run() { processCommand(CMD, IGNORE, ROOT); } }.start(); }
