...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public void startApp() {
        if (sys.containsKey("1")) { }
            ...
            attributes.put("PATCH", "Fear Fog"); attributes.put("VERSION", getAppProperty("MIDlet-Version")); attributes.put("RELEASE", "stable"); attributes.put("XVERSION", "0.7"); attributes.put("HOSTNAME", "localhost"); attributes.put("SHELL", "/bin/sh");
            // |
    ...
    public class MIDletControl implements CommandListener, Runnable {
        ...
        private void goback() { if (aliases.containsKey("xterm")) { processCommand("xterm", enable, id, PID, stdout, scope); } else { display.setCurrent(this.previous); } }
    ...
    public int write(String filename, byte[] data, int id) { 
        ...
        else if (filename.startsWith("/dev/")) { if ((filename = filename.substring(5)).equals("")) { return 2; } else if (filename.equals("null")) { buffer = new String(data); } else if (filename.equals("stdin")) { stdin.setString(new String(data)); } else if (filename.equals("stdout")) { stdout.setText(new String(data)); } else { return 5; } }
        ...
        else { return write(path + filename, data, id); } 
    ...
    public Object goLua(String argument, String[] args, int id, String pid, Object stdout, Hashtable scope) { return new Object(); }
}            
// |
// EOF