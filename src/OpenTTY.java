...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public void startApp() {
        if (!app == true) {
            ...
            else { processCommand("xterm"); processCommand("run initd"); }
        }    
    }
    ...
    private void processCommand(String command) {
        ...
        else if (mainCommand.equals("xterm")) { processCommand("xterm"); }
    ...
    private void xserver(String command) {
        ...
        else if (mainCommand.equals("reset")) { form = new Form(""); processCommand("xterm"); }
