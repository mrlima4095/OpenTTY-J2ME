...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    // C Programming
    // | (Runtime)
    private int C2ME(String code, boolean root) { Hashtable program = build(getcontent(code)); if (program == null) { return 1; } Hashtable main = (Hashtable) program.get("main"); if (main == null) { echoCommand("C2ME: main() missing"); return 1; } else if (((String) main.get("type")).equals("int")) { Vector source = (Vector) main.get("source"); try { String result = C2ME(source, main, root, program, 0); return Integer.valueOf(result); } catch (Exception e) { echoCommand("C2ME: " + getCatch(e)); return 1; } } else { echoCommand("C2ME: main() need to be an int function"); return 2; } } 
    ...
    private String call(String code, Hashtable vars, Hashtable program, boolean root) throws RuntimeException {
        ...
        Hashtable fn = ((Hashtable) program.get("functions")).get(fname)
        ...
        String ret = C2ME((Vector) fn.get("source"), newContext, root, program, 3);
        return ret;
    }
