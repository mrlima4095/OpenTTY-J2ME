...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private int processCommand(String command, boolean ignore, boolean root) { 
        ...
        // |
        // PushRegistry
        else if (mainCommand.equals("prg")) { if (argument.equals("")) { argument = "5"; } try { PushRegistry.registerAlarm(getArgument(argument).equals("") ? "OpenTTY" : getArgument(argument), System.currentTimeMillis() + Integer.parseInt(getCommand(argument)) * 1000); } catch (NumberFormatException e) { echoCommand(getCatch(e)); return 2; } catch (ClassNotFoundException e) { echoCommand("prg: " + getArgument(argument) + ": not found"); return 127; } catch (Exception e) { echoCommand("AutoRunError: " + getCatch(e)); return 3; } }
    ...
    private int caseCommand(String argument, boolean ignore, boolean root) { 
        ...
        else if (METHOD.equals("root")) { CONDITION = username.equals("root"); }
    ...
    public class RemoteConnection implements CommandListener, Runnable { 
        ...
        public RemoteConnection(String args) { 
            ...
            start("remote"); new Thread(this, "Remote").start(); 
