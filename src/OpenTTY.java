...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private int xserver(String command, boolean root) {
        ...
        else if (mainCommand.equals("init")) { form.append(stdout); form.append(stdin); form.addCommand(EXECUTE); processCommand("execute title; x11 cmd;", false, true); form.setCommandListener(this); }
