...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    private Command enterCommand = new Command("Send", Command.OK, 1), helpCommand = new Command("Help", Command.SCRREN, 2), nanoCommand = new Command("Nano", Command.SCREEN, 3), 
