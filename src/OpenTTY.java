    ...
    private int processCommand(String command, boolean ignore) { 
        ...
        // Environment Keys
            ...
            if (argument.equals("")) { } 
                ...
                if (INDEX == -1) { attributes.put(argument, ""); } e
                lse { attributes.put(argument.substring(0, INDEX).trim(), argument.substring(INDEX + 1).trim()); } 
            } 
        } 
        ...
        // |
        // Operators
        else if (mainCommand.equals("if")) { return ifCommand(argument); }
        else if (mainCommand.equals("for")) { return forCommand(argument); }
        else if (mainCommand.equals("case")) { return caseCommand(argument); }
        // |
        // Long executors
        ...
        // HTTP Interfaces
            ...
            if (argument.equals("")) { } 
                ...
                try { 
                    ...
                    int responseCode = CONN.getResponseCode(); echoCommand("Ping to " + argument + " successful, time=" + (System.currentTimeMillis() - START) + "ms"); CONN.close(); 
                } 
