...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public int processCommand(String command, boolean ignore, boolean root) { 
        ...
        else if (aliases.containsKey("_pwd") && indexOf(mainCommand, (String[]) paths.get("/bin/")) != -1) {
        ...
        else if (mainCommand.equals("sh") || mainCommand.equals("login")) { return processCommand(argument.equals("") ? "import /bin/sh" : ". " + argument, false, root); }
