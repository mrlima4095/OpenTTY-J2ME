...
public class OpenTTY extends MIDlet implements CommandListener {
    ...
    public class Monitor implements CommandListener {
        ...
        public Monitor(String command, boolean root) {
            ...
            if (MOD == MONITOR) {
                ...
                preview.addCommand(MOD == EXPLORER ? OPEN : MOD == PROCESS ? KILL : MOD == HISTORY ? RUN : LOAD);
    ...
    private int processCommand(String command, boolean ignore, boolean root) { 
        ...
        else if (mainCommand.equals("build")) { if (argument.equals("")) { return 2; } else { return C2ME(argument, null, root); } }
        ...
        else if (mainCommand.equals("exp")) { new Monitor(argument, root); }
    ...
    private int start(String app, String pid, String collector, boolean root) {
        ...
        if (app.equals("sh") || app.equals("x11-wm")) {
            ...
            else if (app.equals("sh")) { proc.put("stack", new Vector()); proc.put("history", new Vector()); sessions.put(pid, "127.0.0.1"); }
    ...
    private String C2ME(String PID, Vector source, Hashtable context, Hashtable program, boolean root, int mode) throws RuntimeException {
        ...
        for (int i = 0; i < source.size(); i++) {
            ...
            if (type == null) { }
                ...
                String expr = subst(PID, (String) cmd.get("expr"), vars, program, root);
                while (eval(PID, expr, vars, program, root)) {
                    String ret = C2ME(PID, (Vector) cmd.get("source"), context, program, root, 1);
                    expr = subst(PID, (String) cmd.get("expr"), vars, program, root);
