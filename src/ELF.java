...
public class ELF implements CommandListener {
    ...
    public ELF(OpenTTY midlet, Hashtable args, Object stdout, Hashtable scope, int id, String pid, Process proc) {
        ...
        this.memory = new byte[midlet.memory_size * 1024];
        ...
        this.heapStart = 0x40000; // 256KB - heap start
    ...
    private void cleanup() {
        ...
        // The ELF instance may stay referenced via proc.elf in the exited
        // table, so release guest RAM as soon as execution ends.
        memory = null;
