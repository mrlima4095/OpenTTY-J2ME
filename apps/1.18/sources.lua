return {
    ...
    mirror = {
        ...
        ["usermod"] = { remote = "sys/users/usermod.lua", here = "/bin/usermod", description = "Modify user groups" },
        ["groupadd"] = { remote = "sys/users/groupadd.lua", here = "/bin/groupadd", description = "Add groups" },
        ["groupdel"] = { remote = "sys/users/groupdel.lua", here = "/bin/groupdel", description = "Remove groups" },
        ["group"] = { remote = "sys/users/group.lua", here = "/bin/group", description = "Manage groups" },
        ["groups"] = { remote = "sys/users/groups.lua", here = "/bin/groups", description = "Show user groups" },
        ["gpasswd"] = { remote = "sys/users/gpasswd.lua", here = "/bin/gpasswd", description = "Manage group membership" },
