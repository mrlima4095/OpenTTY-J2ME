return {
    ...
    mirror = {
        ...
        ["elflife"] = { remote = "dev/elflife", here = "/bin/elflife", depends = { "libinit" }, arm = true, description = "Test OpenTTY ELF constructors and dependencies" },
        ...
        ["file"] = { remote = "file/file", here = "/bin/file", description = "Detect the type of a file", arm = true },
        ...
        ["libgeo"] = { remote = "lib/libgeo.so", here = "/lib/libgeo.so", arm = true, description = "OpenTTY C geometry library" },
        ["libinit"] = { remote = "lib/libinit.so", here = "/lib/libinit.so", depends = { "libutil" }, arm = true, description = "OpenTTY ELF lifecycle test library" },
        ["libutil"] = { remote = "lib/libutil.so", here = "/lib/libutil.so", arm = true, description = "OpenTTY C utility library" },
