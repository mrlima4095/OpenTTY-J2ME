...
- LCDUI guest ABI (`res/lib/lcdui.h`): `Form`, `List`, `TextBox`, `Alert`, fields, text items and commands with queued events. See [`docs/ELF/LCDUI.md`](docs/ELF/LCDUI.md) for the C API and examples.
